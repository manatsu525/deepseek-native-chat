...
# Per-answer ceilings for ordinary chat. These bound runaway loops; the real
# limit on long tasks is the context budget, not a small round count.
MIMO_MAX_TOOL_ROUNDS = 40
