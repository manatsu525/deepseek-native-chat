...
function customSettings(provider,model=selectedModel()){
  const defaults={thinking:'enabled',reasoning_effort_enabled:true,dsml_fallback_enabled:false,coding_action_reasoning_char_limit:8000,max_completion_tokens:65536,temperature:1,top_p:.95,web_tool_backend:'parallel'};
...
function fillCustomSettings(){
  ...
  $('#customThinking').value=config.thinking;$('#customReasoningEffortEnabled').checked=config.reasoning_effort_enabled;$('#customDsmlFallbackEnabled').checked=config.dsml_fallback_enabled;$('#customCodingActionReasoningLimit').value=config.coding_action_reasoning_char_limit;$('#customMaxCompletion').value=config.max_completion_tokens;$('#customTemperature').value=config.temperature;$('#customTopP').value=config.top_p;$('#customWebToolBackend').value=config.web_tool_backend;
...
async function saveCustomSettings(event){
  ...
  const body={model,thinking:$('#customThinking').value,reasoning_effort_enabled:$('#customReasoningEffortEnabled').checked,dsml_fallback_enabled:$('#customDsmlFallbackEnabled').checked,coding_action_reasoning_char_limit:Number($('#customCodingActionReasoningLimit').value),max_completion_tokens:Number($('#customMaxCompletion').value),temperature:Number($('#customTemperature').value),top_p:Number($('#customTopP').value),web_tool_backend:$('#customWebToolBackend').value};
