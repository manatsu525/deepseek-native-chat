...
function customSettings(provider){return {...{thinking:'enabled',reasoning_effort_enabled:true,include_reasoning_enabled:false,dsml_fallback_enabled:true,max_completion_tokens:65536,temperature:1,top_p:.95,web_tool_backend:'parallel'},...(provider&&provider.settings||{})}}
